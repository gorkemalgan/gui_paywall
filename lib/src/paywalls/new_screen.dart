...
class Paywall4 extends StatelessWidget {
  ...
  const Paywall4({super.key, required this.paywall});
                  ...
                  Expanded(
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: idx == 0 ? Colors.black : Colors.grey[850],
                      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //Image.asset('assets/images/mascot_m.png', height: 10, fit: BoxFit.cover),
                          const SizedBox(height: 10),
                          Text(
                            p.planName,
