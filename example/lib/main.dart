  ...
  PaywallConfig _createMockPaywallConfig(BuildContext context) {
    final products = [
      PaywallProduct(
        ...
        title: {'text': ProductPeriod.weekly.getTitle(context)},
        description: {'text': ProductPeriod.weekly.getDescription(context)},
      ),
      PaywallProduct(
        storeId: 'monthly_sub',
        price: 9.99,
        ...
        title: {'text': ProductPeriod.monthly.getTitle(context)},
        description: {'text': ProductPeriod.monthly.getDescription(context)},
        freeTrialDays: 3,
      ),
      PaywallProduct(
        storeId: 'yearly_sub',
        ...
        title: {'text': ProductPeriod.yearly.getTitle(context)},
        description: {'text': ProductPeriod.yearly.getDescription(context)},
        freeTrialDays: 7,
      ),
    ];
